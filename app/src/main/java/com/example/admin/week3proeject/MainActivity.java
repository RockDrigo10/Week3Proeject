...
import com.example.admin.week3proeject.Model.Book;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar snackbar = Snackbar.make(view,"https://github.com/RockDrigo10", Snackbar.LENGTH_INDEFINITE)
    ...
    private void loadFirstPage() {
        final retrofit2.Call<ArrayList<Book>> bookCall = RetroFitHelper.getBooks();
